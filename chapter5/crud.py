...
def get_players(db: Session, skip: Optional[int] = 0, limit: Optional[int] = 100,
...
def get_performances(db: Session, skip: Optional[int] = 0, limit: Optional[int] = 100,
                     min_last_changed_date: Optional[date] = None):
...
def get_leagues(db: Session, skip: Optional[int] = 0, limit: Optional[int] = 100,
                 min_last_changed_date: Optional[date] = None,league_name: Optional[str] = None):
...
def get_teams(db: Session, skip: Optional[int] = 0, limit: Optional[int] = 100,
              min_last_changed_date: Optional[date] = None,
              team_name: Optional[str] = None, league_id: Optional[int] = None):
